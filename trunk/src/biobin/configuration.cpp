...
void Configuration::Init() {
	InitKey("SETTINGS_DB", Utility::ENV("SETTINGS_DB", BIODB).c_str(),
			"BioFilter data");
	InitKey(
			"VCF_FILE",
			"",
...
void Configuration::LoadFileContents(const char *key,
		Utility::IdCollection& fileContents) {
...
void Configuration::LoadFileContents(const char *key,
		Utility::StringArray& fileContents) {
...
void Configuration::ExecuteConfiguration(BinApplication* app) {
	...
	Task::GenerateFiles::OutputDelimiter = sep;
	...
	if (Task::GenerateFiles::WriteBinData
			|| Task::GenerateFiles::WriteGenotypeData) {
